...
function [U, computn_time, n] = PDHG_PDE_solver_on_interval_with_initial(epsilon_0, U_initial_2D, L, N_x, T, N_t, Iter_number, tau_P, tau_U, omega)
% U: numerical solution on the N_t th subinterval
% computn_time: computation time of PDHG method
% n: number of iterations needed by the PDHG method when ||Res|| < tol
